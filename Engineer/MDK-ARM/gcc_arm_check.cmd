...
for %%F in (../APPLICATION/arm/arm_tool.c ../APPLICATION/arm/arm_kinematics.c ../APPLICATION/arm/arm_trajectory.c ../APPLICATION/arm/arm.c ../APPLICATION/app_runtime.c) do (
  echo Checking %%F
