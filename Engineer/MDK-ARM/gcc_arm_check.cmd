...
for %%F in (../Core/Src/tim.c ../Core/Src/gpio.c ../Core/Src/stm32f4xx_it.c ../MODULE/servo/mg995_servo.c ../MODULE/protocol/protocol.c ../MODULE/protocol/protocol_port.c ../MODULE/protocol/protocol_runtime.c ../APPLICATION/chassis/chassis.c ../APPLICATION/arm/arm_tool.c ../APPLICATION/arm/arm_kinematics.c ../APPLICATION/arm/arm_path_planner.c ../APPLICATION/arm/arm_trajectory.c ../APPLICATION/arm/arm.c ../APPLICATION/app_arm_command_id.c ../APPLICATION/app_arm_flow.c ../APPLICATION/app_fruit_task.c ../APPLICATION/app_arm_side_pick_place.c ../APPLICATION/camera_target_transform.c ../APPLICATION/upper_controller_bridge.c ../APPLICATION/app_runtime.c) do (
  echo Checking %%F
  "%GCC%" %FLAGS% %INCS% %%F || exit /b 1
)
echo Checking ../APPLICATION/app_runtime.c in host-control mode
"%GCC%" %FLAGS% %INCS% -DAPP_MODE=6u ../APPLICATION/app_runtime.c || exit /b 1
exit /b 0
