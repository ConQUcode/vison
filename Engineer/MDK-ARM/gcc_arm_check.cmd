...
for %%F in (../Core/Src/tim.c ../Core/Src/gpio.c ../Core/Src/stm32f4xx_it.c ../MODULE/servo/mg995_servo.c ../MODULE/protocol/protocol.c ../MODULE/protocol/protocol_port.c ../MODULE/protocol/protocol_runtime.c ../APPLICATION/chassis/chassis.c ../APPLICATION/arm/arm_tool.c ../APPLICATION/arm/arm_kinematics.c ../APPLICATION/arm/arm_trajectory.c ../APPLICATION/arm/arm.c ../APPLICATION/app_arm_command_id.c ../APPLICATION/app_arm_flow.c ../APPLICATION/app_fruit_task.c ../APPLICATION/app_arm_side_pick_place.c ../APPLICATION/fruit_usb_bridge.c ../APPLICATION/camera_target_transform.c ../APPLICATION/upper_controller_bridge.c ../APPLICATION/app_runtime.c) do (
  echo Checking %%F
